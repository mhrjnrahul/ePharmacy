...
import {
  ...
  ClipboardList, ArrowLeftRight, BarChart2, UserCog, ScrollText, LogOut,
} from "lucide-react"
import type { User } from "@/types"


const navItems: { label: string; path: string; icon: any; roles: User["role"][] }[] = [
  { label: "Dashboard",         path: "/dashboard",         icon: LayoutDashboard, roles: ["ADMIN", "STAFF"]                  },
  { label: "Products",          path: "/products",          icon: Pill,            roles: ["ADMIN", "STAFF"]                  },
  { label: "Categories",        path: "/categories",        icon: Tags,            roles: ["ADMIN", "STAFF"]                  },
  { label: "Suppliers",         path: "/suppliers",         icon: Truck,           roles: ["ADMIN", "STAFF"]                  },
  ...
  { label: "Orders",            path: "/orders",            icon: ShoppingCart,    roles: ["ADMIN", "STAFF", "CUSTOMER"]      },
