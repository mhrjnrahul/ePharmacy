    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "24px" }}>
          ...
          <button
            onClick={onClose}
            style={{ background: "none", border: "none", cursor: "pointer", color: gray[400], display: "flex", padding: "4px" }}
          >
            <X size={18} />
          </button>
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            ...
            />
            <label htmlFor="is_active" style={{ fontSize: "13px", fontWeight: 500, color: gray[700], cursor: "pointer" }}>
              Active
            </label>
          </div>
        ...
        <div style={{ display: "flex", gap: "10px", marginTop: "24px", justifyContent: "flex-end" }}>
          <button
            onClick={onClose}
            style={{
              padding: "8px 16px", borderRadius: "8px", border: `1px solid ${gray[200]}`,
              backgroundColor: "#fff", fontSize: "13px", fontWeight: 500, color: gray[700], cursor: "pointer",
            }}
          >
            Cancel
          </button>
          <button
            ...
            style={{
              ...
              backgroundColor: green[600], fontSize: "13px", fontWeight: 600,
...
const DeleteModal = ({ category, onConfirm, onClose, isDeleting }: DeleteModalProps) => (
  <div style={{
    position: "fixed", inset: 0, backgroundColor: "rgba(0,0,0,0.4)",
    display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50,
  }}>
    <div style={{
      ...
      <p style={{ fontSize: "13px", color: gray[500], margin: "0 0 24px 0", lineHeight: 1.6 }}>
        Are you sure you want to delete <strong style={{ color: gray[900] }}>{category.name}</strong>?
        This action cannot be undone.
      </p>
      <div style={{ display: "flex", gap: "10px", justifyContent: "flex-end" }}>
        <button
          onClick={onClose}
          style={{ padding: "8px 16px", borderRadius: "8px", border: `1px solid ${gray[200]}`, backgroundColor: "#fff", fontSize: "13px", fontWeight: 500, color: gray[700], cursor: "pointer" }}
        >
          Cancel
        </button>
        <button
          ...
          style={{
            display: "flex", alignItems: "center", gap: "6px",
            padding: "8px 18px", borderRadius: "8px", border: "none",
            backgroundColor: red[600], fontSize: "13px", fontWeight: 600,
    ...
    <div>
      ...
      {categories.length === 0 ? (
        <div style={{
          ...
          backgroundColor: "#fff", borderRadius: "12px", border: `1px solid ${gray[200]}`,
        }}>
          <div style={{
            width: "48px", height: "48px", borderRadius: "12px", backgroundColor: green[50],
          ...
          <p style={{ fontSize: "13px", color: gray[500], margin: "0 0 20px 0" }}>Add your first category to organise products.</p>
          <button
            onClick={openAdd}
            style={{
              ...
              <tr style={{ backgroundColor: gray[50], borderBottom: `1px solid ${gray[200]}` }}>
                {["Name", "Status", "Description", "Created", ""].map(h => (
                  <th key={h} style={{
                    ...
                    fontWeight: 600, color: gray[500], textTransform: "uppercase",
              ...
              {categories.map((cat, i) => (
                ...
                >
                  ...
                  <td style={{ padding: "12px 16px" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                      <div style={{
                        width: "30px", height: "30px", borderRadius: "8px", backgroundColor: green[50],
                  ...
                  <td style={{ padding: "12px 16px" }}>
                    <span style={{
                      ...
                      backgroundColor: cat.is_active ? green[50] : gray[100],
                      color: cat.is_active ? green[700] : gray[500],
                    }}>
      ...
      {/* Add / Edit modal */}
      {modalOpen && (
        <CategoryModal editing={editing} onClose={closeModal} />
      )}
